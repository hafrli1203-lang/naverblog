...
CATEGORY_SYNONYMS = {
    ...
    "양식": "음식", "분식": "음식",
    "헤어": "미용", "뷰티": "미용", "살롱": "미용", "펌": "미용",
    "렌즈": "안경", "안과": "안경",
    "피트니스": "헬스", "필라테스": "헬스", "요가": "헬스", "크로스핏": "헬스",
    "의원": "병원", "클리닉": "병원", "정형외과": "병원", "한의원": "병원",
    "임플란트": "치과", "교정": "치과",
    "호텔": "숙박", "펜션": "숙박", "리조트": "숙박", "게스트하우스": "숙박", "모텔": "숙박",
    "과외": "학원", "입시": "학원",
    "정비": "자동차", "세차": "자동차", "카센터": "자동차",
    # 신규 4개 업종
    "네일": "네일샵", "네일샵": "네일샵", "네일아트": "네일샵", "젤네일": "네일샵",
    "피부과": "피부과", "피부관리": "피부과", "에스테틱": "피부과", "피부미용": "피부과",
    "인테리어": "인테리어", "리모델링": "인테리어", "시공": "인테리어", "집꾸미기": "인테리어",
    "꽃집": "꽃집", "플라워샵": "꽃집", "꽃가게": "꽃집", "플라워": "꽃집",
}
...
CATEGORY_HOLDOUT_MAP = {
    ...
    "네일샵": ["{r} 네일 잘하는곳", "{r} 젤네일 추천", "{r} 네일아트 가격"],
    "피부과": ["{r} 피부과 잘하는곳", "{r} 피부관리 추천", "{r} 피부과 가격"],
    "인테리어": ["{r} 인테리어 업체 추천", "{r} 리모델링 후기", "{r} 인테리어 비교"],
    "꽃집": ["{r} 꽃집 추천", "{r} 꽃배달 후기", "{r} 플라워샵 가격"],
}
...
REGION_POWER_MAP = {
    ...
    "네일샵": ["{r} 맛집 추천", "{r} 카페 추천", "{r} 핫플"],
    "피부과": ["{r} 맛집 추천", "{r} 카페 추천", "{r} 핫플"],
    "인테리어": ["{r} 맛집 추천", "{r} 카페 추천", "{r} 핫플"],
    "꽃집": ["{r} 맛집 추천", "{r} 카페 추천", "{r} 핫플"],
...
CATEGORY_BROAD_MAP = {
    ...
    "네일샵": ["{r} 네일 추천", "{r} 젤네일 가격", "{r} 네일아트 디자인", "{r} 손톱 관리", "{r} 페디큐어"],
    "피부과": ["{r} 피부과 추천", "{r} 레이저 시술", "{r} 여드름 치료", "{r} 피부관리실", "{r} 에스테틱"],
    "인테리어": ["{r} 인테리어 추천", "{r} 리모델링 비용", "{r} 집꾸미기", "{r} 셀프인테리어", "{r} 시공 후기"],
    "꽃집": ["{r} 꽃배달", "{r} 플라워클래스", "{r} 화환 추천", "{r} 꽃다발 가격", "{r} 플라워샵 추천"],
}
